        ...
        <div className="dashboard-layout">
            ...
            <main className="main-content" style={{
                ...
                <header style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? '1rem' : '3.5rem', flexShrink: 0 }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', minWidth: isMobile ? 'auto' : '140px' }}>
                            ...
                            <div style={{ fontSize: isMobile ? '0.9rem' : '1.1rem', fontWeight: 900, color: 'var(--text-primary)', marginTop: '2px', whiteSpace: 'nowrap' }}>
                    ...
                    <div style={{ display: 'flex', gap: isMobile ? '0.5rem' : '1.25rem', alignItems: 'center', flexShrink: 1, overflow: 'hidden' }}>
                        {/* Role Selector Pill */}
                        {!isMobile && (
                            <div style={{ position: 'relative' }} ref={roleDropdownRef}>
                                ...
                                >
                                    ...
                                    <span style={{ maxWidth: '100px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{currentRole}</span>
                        ...
                        {/* Points/Modules Pill */}
                        <div style={{
                            height: '42px', padding: isMobile ? '0 0.75rem' : '0 1.25rem', borderRadius: '14px',
                            background: isDarkMode ? '#111' : '#fff',
                            ...
                            <div style={{ padding: '5px', background: 'rgba(59, 130, 246, 0.1)', borderRadius: '6px' }}>
                                <Sparkles size={isMobile ? 12 : 14} color="#3b82f6" fill="#3b82f6" />
                            </div>
                        ...
                        <motion.button
                            ...
                            onClick={() => window.location.href = 'https://pages.razorpay.com/pl_S7Hmm9y3KCV723/view'}
                            style={{
                                height: '42px', padding: isMobile ? '0 1rem' : '0 1.25rem', borderRadius: '14px',
                                background: '#FF5722',
                                color: '#fff', border: 'none',
                                fontWeight: 800, fontSize: isMobile ? '0.75rem' : '0.85rem', cursor: 'pointer',
                                display: 'flex', alignItems: 'center', gap: '6px',
                                boxShadow: '0 4px 15px rgba(255, 87, 34, 0.3)'
                            }}
                        >
                            <Sparkles size={isMobile ? 12 : 14} fill="#fff" />
                            {isMobile ? 'Pro' : 'Go Pro'}
                        </motion.button>
