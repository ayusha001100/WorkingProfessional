...
import { ShieldCheck, Zap, Sparkles, ChevronRight, ArrowRight, Mail, Globe } from 'lucide-react';
...
export default function Login() {
    ...
    useEffect(() => {
        const handleMouseMove = (e) => {
            ...
            const xMove = (clientX - window.innerWidth / 2) / 40;
            const yMove = (clientY - window.innerHeight / 2) / 40;
    ...
    const containerVariants = {
        ...
        visible: {
            ...
            transition: { staggerChildren: 0.1, delayChildren: 0.2, duration: 0.8, ease: [0.16, 1, 0.3, 1] }
        }
    };
