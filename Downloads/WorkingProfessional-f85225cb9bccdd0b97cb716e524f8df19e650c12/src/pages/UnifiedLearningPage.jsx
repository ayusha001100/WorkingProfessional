                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', paddingTop: '1.25rem' }}>
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.25rem' }}>
                                                ...
                                                <div>
                                                    <div style={{ fontSize: '0.85rem', fontWeight: 800, color: isDarkMode ? '#fff' : '#1e293b' }}>SaiKiran Sondarkar</div>
                                                    <div style={{ fontSize: '0.7rem', color: '#64748b', fontWeight: 600 }}>Founder and Ceo of Letsupgrade</div>
                                                </div>
                                            </div>
                                        ...
                                        <motion.button
                                            ...
                                            whileTap={{ scale: 0.98 }}
                                            onClick={() => window.open("https://luc.to/genai-sat-zoom-wp-even", "_blank")}
                                            style={{
